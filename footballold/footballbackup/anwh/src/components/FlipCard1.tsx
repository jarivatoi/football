  ...
  useEffect(() => {
    ...
    const createFlipTimeline = () => {
      ...
      timelineRef.current
        ...
        // Swap opacity at the midpoint of the flip to prevent double-display on iOS
        .to(front, { opacity: 0, duration: animationDuration * 0.1 }, animationDuration * 0.45)
        .to(back, { opacity: 1, duration: animationDuration * 0.1 }, animationDuration * 0.45);
